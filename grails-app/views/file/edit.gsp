                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="fileContent"><g:message code="file.fileContent.label" default="File Content" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: fileInstance, field: 'fileContent', 'errors')}">
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="task"><g:message code="file.task.label" default="Task" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: fileInstance, field: 'task', 'errors')}">
                                    <g:select name="task.id" from="${todo.Task.list()}" optionKey="id" value="${fileInstance?.task?.id}"  />
                                </td>
                            </tr>
